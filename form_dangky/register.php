...
<div class="container">
    ...
    <div class="content">
        ...
        <!--				tạo form-->
        <form class="form-horizontal" id="regester" method="post" action="render.php"> <!--//dung post trong form-->
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <input  onclick="reg()"   type="button" class="btn btn-default" value="Đăng ký" >
